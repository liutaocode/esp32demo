...
[口袋朗读员 · 中文 TTS Demo](examples/chinese-tts/README.zh_CN.md)：离线中文朗读、十二组示例、六档语速，可通过代码传入自定义文本。语音库约 **930 KB**。这是供开发者复用的示例工程，正在提交社区审核。

[嘴硬小豆](examples/mouthy-bean/README.zh_CN.md)：大眼睛中文语音玩具，竖耳倾听、随机思考、摸摸逗逗和八种表情收藏。独立目录构建，灵感来自「小狮日记」。
