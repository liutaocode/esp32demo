...
See the [Tally Click manual](../README.md) for counter controls, persistence and sound behavior. The template documentation below remains the board and engineering reference.
