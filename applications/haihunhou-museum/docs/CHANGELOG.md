...
- Added a boot-direct, offline Haihunhou Museum pocket tour with eight
  research-backed objects, a historical protagonist and museum-director profile,
  practical visit information, original code-drawn illustrations, a
  story/detail toggle, an always-visible battery indicator, and 22 interruptible
  offline Chinese TTS narrations played from a non-blocking worker task.
