...
parser.add_argument("render_dir", type=Path, help="Directory where tests/down_100_ui/preview ran")
args = parser.parse_args()
output = ROOT / "assets/images/down_100"
...
for index, name in enumerate(("home", "play", "deep", "pause", "help", "victory")):
