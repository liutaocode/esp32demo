...
- 新增听听小岛：384 句离线英语、中文按键界面、随身听、寻宝答题、错题回听、印章保存和休息定时。保留 Recovery 与设备身份，打包并校验新增音频资源。实机验收待后续完成。

## 1.0.1

- 随身听和答题反馈增加英文原句，与中文译文同时显示。导航仍为中文，未答题时隐藏英文。语音峰值统一至 -1.5 dBFS，提高五档音量，迁移已有进度并保留印章与学习记录。

## 1.0.2

- 应用更名为英语磨耳朵，同步设备标题和发布文案，保留学习进度及应用标识。
