...
16-second duration limit, or Flash write. The book worker in `main/ebook` splits text, manages reading position and submits
subsequent sentences. See the root README for the TTS reader controls.
...
0x700000 remain unchanged. The reader uses 0x360000–0x700000 (3.625 MiB) for
book storage with the original FAT filesystem layout. Previous voice
