#!/usr/bin/env python3
"""Regenerate Perfect Slice's Chinese subset from its UI source."""
from pathlib import Path
import subprocess

ROOT = Path(__file__).resolve().parents[1]
source = (ROOT / "main/apps/perfect_slice/perfect_slice.c").read_text()
...
subprocess.run([
    ...
    "--lv-include", "lvgl.h", "--lv-font-name", "perfect_slice_zh_16",
    "--lv-fallback", "lv_font_montserrat_14",
    "-o", str(ROOT / "assets/fonts/perfect_slice_zh_16.c"),
], check=True)
