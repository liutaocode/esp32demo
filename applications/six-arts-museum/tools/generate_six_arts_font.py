#!/usr/bin/env python3
"""Regenerate the Six Arts Museum LVGL Chinese glyph subset."""
...
SOURCE = ROOT / "main/six_arts_museum.c"
OUTPUT = ROOT / "assets/fonts/six_arts_zh_16.c"
...
def main() -> None:
    ...
    generated = generated.replace(str(OUTPUT), "assets/fonts/six_arts_zh_16.c")
