...
run_static_checks() {
    ...
    python3 tools/generate_night_call_story.py --check
    python3 tools/generate_night_call_font.py --check
    python3 tools/generate_night_call_audio.py --check
    python3 tools/test_night_call.py
    python3 tools/test_night_call_ui.py
