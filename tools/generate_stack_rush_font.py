#!/usr/bin/env python3
"""Regenerate Stack Rush's Chinese subset from its UI source."""
from pathlib import Path
import subprocess

ROOT = Path(__file__).resolve().parents[1]
source = (ROOT / "main/apps/stack_rush/stack_rush.c").read_text()
...
subprocess.run([
    ...
    "--lv-include", "lvgl.h", "--lv-font-name", "stack_rush_zh_16",
    "--lv-fallback", "lv_font_montserrat_14",
    "-o", str(ROOT / "assets/fonts/stack_rush_zh_16.c"),
], check=True)
