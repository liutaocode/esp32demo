#!/usr/bin/env python3
"""Regenerate Fruit Merge's Chinese font subsets from its UI source."""
...
for size in (12, 16, 24):
    ...
    if args.check:
        ...
        print(f"Fruit Merge {size}px font: {len(symbols)} UI characters covered")
        continue
    subprocess.run([
