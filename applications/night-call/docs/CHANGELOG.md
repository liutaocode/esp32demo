...
- Fixed a device-only stack overflow during Chinese screen captures; the capture worker now reserves 8 KiB and reports its remaining stack after a successful capture.

- Added Night Call: three linked calls, 22 branching scenes, six clues, seven endings, offline Mandarin dialogue, Chinese button UI and resumable progress.
