#!/usr/bin/env python3
"""Regenerate the Haihunhou Museum LVGL Chinese glyph subset."""
...
SOURCE = ROOT / "main/haihunhou_museum.c"
OUTPUT = ROOT / "assets/fonts/haihunhou_zh_16.c"
...
def main() -> None:
    ...
    generated = generated.replace(str(OUTPUT), "assets/fonts/haihunhou_zh_16.c")
