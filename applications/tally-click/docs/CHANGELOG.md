...
## Tally Click 1.2.0 — 2026-09-06

- Start counting immediately. Remove clock setup and timestamps while migrating existing numbers into ten ordered results. Use precomputed PCM, continuous audio supply and 5 ms crossfades; defer automatic count saves while audio is active.

## Tally Click 1.1.0 — 2026-09-06

- Replace the themed panel with a full-screen charcoal digital counter. Add tall vector numerals, bounce and color-pulse feedback, archive scan-line/particles and distinct asynchronous sounds for keys and actions. Verify animation bounds, waveform envelopes and audio preemption/failure behavior.

## Tally Click 1.0.0 — 2026-09-06

- Add an isolated Chinese counter with exact press counting, pause, transactional reset, ten persistent dated records and offline clock confirmation. Include fault-injection and real-LVGL layout checks. Hardware installation and community submission are pending.
