...
- Add Listening Island: 384 offline English sentences, a Chinese button interface, continuous listening, treasure quizzes, mistake replay, persistent stamps and rest timers. Preserve Recovery and device identity; package and verify the additional audio resource. Device acceptance remains pending.

## 1.0.1

- Show the English sentence alongside its Chinese translation during listening and answer feedback. Keep navigation Chinese and hide English during unanswered quizzes. Normalize speech peaks to -1.5 dBFS and raise the five volume levels; migrate existing progress without resetting stamps or history.

## 1.0.2

- Rename the application to English Listening Practice in the on-device title and release copy. Keep progress and application identifiers intact.
