...
parser.add_argument("render_dir", type=Path, help="Directory where tests/clean_sweep_ui/preview ran")
args = parser.parse_args()
output = ROOT / "assets/images/clean_sweep"
...
for index, name in enumerate(("home", "play", "clear-flash", "tetris", "perfect", "result")):
