...
- Cat Is Here 0.1.2: separated meow, purr and toy cues into random banks with no consecutive repeats; added double-Confirm dancing with sunglasses, moving paws and an original beat, 32-second finish and any-key stop. Added compact ADPCM streaming and gesture/audio regression coverage.

- Cat Is Here 0.1.1: replaced barely audible synthesis with CC0 cat purr/meow recordings, increased output gain, added a dedicated audio worker and bounded purr continuation, and made enabling sound play a purr preview.


- Added Cat Is Here: a Chinese three-button companion with eleven poses, names/coats/toys, quiet synthesized sounds, persistent shared memories, and desk/portable display modes. Added production-renderer typography/visibility checks and review drafts; installation and publication remain pending.
