#!/usr/bin/env python3
"""Regenerate Rhythm Agent's Chinese font subsets from its UI source."""
...
for size in (12, 16, 24):
    ...
    if args.check:
        ...
        print(f"Rhythm Agent {size}px font: {len(symbols)} UI characters covered")
        continue
    subprocess.run([
