...
run_firmware_checks() (
    ...
    install -m 0644 "${validation_build_dir}/FoloToy-AI-Passport.bin" "${repo_root}/build/FoloToy-AI-Passport.bin"
    python3 tools/cat/artifact.py "${repo_root}/build/FoloToy-AI-Passport-full.bin"
